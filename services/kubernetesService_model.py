...
def kube_create_job_object(name, container_image, namespace="default", container_name="jobcontainer", env_vars={}):
    ...
    for env_name, env_value in env_vars.items():
        ...
        container = client.V1Container(name=container_name, image=container_image, env=env_list, image_pull_policy=None)
...
def kube_create_job(worker):
    # Create the job definition
    container_image = worker
    name = id_generator()
    # name = worker.replace('/', '-')
    body = kube_create_job_object(name, container_image, env_vars={ "MYSQL_ROOT_PASSWORD":"my-secret-pw"})
